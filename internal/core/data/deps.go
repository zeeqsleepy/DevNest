...
//
// Three methods, all read-only. The module cannot walk a tree, write a file,
// or open a socket, and the interface is what enforces that rather than a
// comment asking nicely. A test satisfies it with a string.
